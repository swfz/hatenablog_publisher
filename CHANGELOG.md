...
## [v0.4.2](https://github.com/swfz/hatenablog_publisher/compare/v0.4.1...v0.4.2) - 2026-04-24
...
- fix(ci): slack-workflow-statusをnode24対応フォークに切り替え by @swfz in https://github.com/swfz/hatenablog_publisher/pull/196
- chore: sync renovate config from github-config by @swfz in https://github.com/swfz/hatenablog_publisher/pull/197
- chore: sync renovate config from github-config by @swfz in https://github.com/swfz/hatenablog_publisher/pull/198
- fix(ci): RuboCopとactions/cacheのdeprecation対応 by @swfz in https://github.com/swfz/hatenablog_publisher/pull/200
